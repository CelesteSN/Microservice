...
exports.default = {
    errorClaim: {
        ERROR_LIST_CLAIMS: { errorCode: 404, error_message: "No existen reclamos" },
        ...
        NULL_STATUS_REVIEW: { errorCode: 400, error_message: "Null status, it is required" },
        NULL_ANSWER_REVIEW: { errorCode: 400, error_message: "Null answer, it is required" },
        ...
        NOT_VALID_USER: { errorCode: 400, error_message: "User not valid for this operation" },
